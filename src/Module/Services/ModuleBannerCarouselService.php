...
use Noking50\Modules\BannerCarousel\Repositories\ModuleBannerCarouselRepository;
use Noking50\Modules\BannerCarousel\Repositories\ModuleBannerCarouselLangRepository;
use User;

class ModuleBannerCarouselService {

    protected $moduleBannerCarouselRepository;
    protected $moduleBannerCarouselLangRepository;

    public function __construct(ModuleBannerCarouselRepository $moduleBannerCarouselRepository
    , ModuleBannerCarouselLangRepository $moduleBannerCarouselLangRepository) {
        $this->moduleBannerCarouselRepository = $moduleBannerCarouselRepository;
        $this->moduleBannerCarouselLangRepository = $moduleBannerCarouselLangRepository;
    }

    public function getListBackend($group) {
        $dataSet = $this->moduleBannerCarouselRepository->listBackend($group);

        return $dataSet;
    }

    public function getListFrontend($group) {
        $dataSet = $this->moduleBannerCarouselRepository->listFrontend($group);
